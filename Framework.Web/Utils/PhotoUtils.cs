...
namespace Framework.Web.Utils
{
    public class PhotoUtils
    {
        ...
        {
            var extension = Path.GetExtension(fileSaveUrl);
            ...
            else
            {
                ...
                ImageCodecInfo ici = icis[0];
                foreach (ImageCodecInfo i in icis)
                {
                    if (i.FormatDescription.Equals(formatDesc))
                    {
                        ici = i;
                        break;
                    }
        ...
        public static void CutForCustom(System.IO.Stream fromFile, string fileSaveUrl, int maxWidth, int maxHeight, int quality)
        {
            ...
            else
            {
                ...
                if (templateRate == initRate)
                {
                    ...
                    templateImage.Save(fileSaveUrl, format);
                }
                //原图与模版比例不等，裁剪后缩放
                else
                {
                    ...
                    //设置质量
                    //pickedG.CompositingQuality = System.Drawing.Drawing2D.CompositingQuality.;
                    pickedG.InterpolationMode = System.Drawing.Drawing2D.InterpolationMode.HighQualityBicubic;
                    pickedG.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
                    ...
                    System.Drawing.Image templateImage = new System.Drawing.Bitmap(maxWidth, maxHeight);
                    System.Drawing.Graphics templateG = System.Drawing.Graphics.FromImage(templateImage);
                    //templateG.CompositingQuality = System.Drawing.Drawing2D.CompositingQuality.HighSpeed;
