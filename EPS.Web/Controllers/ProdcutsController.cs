...
namespace EPS.Web.Controllers
{
    public class ProductsController : BaseController
    {
        ...
        public ProductsController(INews news, IPhoto photo, IModule module, ICacheManager cache)
        {
            _news = news;
            _photo = photo;
            _module = module;
        ...
        public ActionResult Index(int page = 1, int ParentId = 21, int ModuleId = 22)
        {
